...
def init_built_in_data(data):
    ...
    built_in_recipes = [
        ...
        # 村驴红烧肉
        {
            ...
            'difficulty': '中等',
            'servings': 4,
            'ingredients': ['五花肉 2斤', '冰糖 50g', '生姜 3片', '大葱 3段', '八角 2个', '香叶 2片', '桂皮 1小块', '干辣椒 适量', '高度白酒 2勺', '生抽 4勺', '红腐乳汁 2勺', '盐 1茶勺', '味精 适量', '大蒜片 适量'],
            'steps': [
                '铁锅烧热,将猪皮在锅上蹭至发黑,泡水后刮净(去毛去腥关键)',
                '整块五花肉冷水下锅焯水,水开后捞出,涮干净不再水洗',
                '切成两指宽的块,锅里下少量油煎肉',
                '大火炒至不粘锅,转中小火煎3分钟至几面金黄,猪油留用',
                '锅里下冰糖50g和少量油,中火炒糖色',
                '等小泡变大泡冒烟颜色变深,转小火',
                '泡泡消失糖浆变枣红色时下肉,小火炒匀',
                '中大火炒香,锅边加两勺高度白酒,炒到酒气挥发',
                '小火加生抽4勺、红腐乳汁2勺、盐1茶勺,炒匀',
                '加三碗水大火煮开,转入高压锅压30分钟',
                '倒回锅里大火收汁,出锅前加味精和大蒜片'
            ],
            'notes': '炒糖色是关键,枣红色立刻下肉,炒过了会发苦。'
        },
        # 糖醋里脊
        {
            'id': 'cunlv_010',
            ...
            'difficulty': '中等',
            'servings': 3,
            'ingredients': ['猪里脊 300g', '土豆淀粉 150g', '番茄酱 3勺', '白糖 3勺', '白醋 2勺', '料酒 1勺', '盐 少许', '葱姜水 适量', '食用油 适量'],
            'steps': [
                '猪里脊切条,加盐、料酒、葱姜水腌制15分钟',
                '土豆淀粉加水浸泡沉淀,倒掉上层清水,用底部湿淀粉挂糊',
                '肉条裹湿淀粉,油温160度逐条下锅炸至定型捞出',
                '升高油温至180度,复炸至金黄酥脆',
                '锅留底油,下番茄酱炒出红油',
                '加白糖、白醋、少量水熬至冒泡粘稠',
                '倒入炸好的里脊快速翻匀,让每块都裹上酱汁',
                '出锅装盘,外酥里嫩酸甜可口'
            ],
            'notes': '复炸是酥脆的关键,酱汁要快速裹匀。'
        },
        # 可乐鸡翅
        {
            'id': 'cunlv_011',
            ...
            'difficulty': '简单',
            'servings': 2,
            'ingredients': ['鸡翅中 10个', '可乐 1听', '生抽 2勺', '老抽 半勺', '料酒 1勺', '姜片 3片', '葱段 适量', '八角 1个', '盐 少许'],
            'steps': [
                '鸡翅洗净,两面各划两刀方便入味',
                '冷水下锅,加葱姜料酒焯水,煮沸后撇去浮沫捞出沥干',
                '锅内少许油烧热,放入鸡翅',
                '煎至两面金黄泛色',
                '倒入可乐没过鸡翅',
                '加生抽、老抽、八角、葱段、姜片',
        ...
        # 西红柿炖牛腩
        {
            ...
            'difficulty': '中等',
            'servings': 4,
            'ingredients': ['牛腩 500g', '西红柿 4个', '洋葱 半个', '番茄酱 2勺', '生姜 1块', '大葱 1段', '八角 2个', '香叶 2片', '生抽 2勺', '盐 适量', '糖 1勺'],
            'steps': [
                '牛腩切大块冷水下锅,加葱姜料酒焯水5分钟,捞出温水洗净',
                '西红柿顶部划十字,开水烫后去皮切块',
                '洋葱切块,姜切片葱切段',
                '锅中放油,爆香葱姜八角香叶',
                '下牛腩翻炒至表面变色',
        ...
        # 蒜蓉粉丝蒸扇贝
        {
            ...
            'difficulty': '简单',
            'servings': 2,
            'ingredients': ['扇贝 6个', '粉丝 1小把', '大蒜 1头', '小葱 2根', '红椒 半个', '蒸鱼豉油 2勺', '料酒 1勺', '食用油 适量'],
            'steps': [
                '粉丝温水泡软剪短,大蒜剁成蒜蓉',
                '蒜蓉分两半,一半用油小火炒香至金黄(金银蒜)',
                '扇贝处理干净,留半壳,放粉丝',
                '扇贝肉放粉丝上,料酒去腥',
                '两种蒜蓉混合铺在扇贝上',
                '水开后上锅蒸5-6分钟',
        ...
        # 蒜蓉开背虾
        {
            ...
            'difficulty': '简单',
            'servings': 2,
            'ingredients': ['大虾 10只', '大蒜 1头', '粉丝 1小把', '小葱 2根', '红椒 半个', '生抽 2勺', '料酒 1勺', '盐 少许', '糖 少许', '食用油 适量'],
            'steps': [
                '大虾洗净,剪去虾须虾脚',
                '用刀从虾背中间划开,挑去虾线(开背口稍深但别剪断)',
                '用盐、生抽、料酒、葱姜蒜末、红椒、糖调蒜蓉汁',
                '粉丝泡软铺盘底',
                '开背虾摆在粉丝上,蒜蓉汁舀入虾背',
                '水开后上锅蒸3-4分钟',
                '出锅撒葱花,热油浇香'
        ...
        # 红烧排骨
        {
            ...
            'difficulty': '中等',
            'servings': 3,
            'ingredients': ['排骨 500g', '冰糖 20g', '生抽 3勺', '老抽 1勺', '料酒 2勺', '生姜 1块', '大葱 1段', '八角 2个', '桂皮 1小块', '香叶 2片', '盐 适量'],
            'steps': [
                '排骨剁块冷水下锅,加葱姜料酒焯水,撇浮沫捞出',
                '温水冲洗干净沥干',
                '锅中少油放冰糖,小火炒糖色',
                '糖色变枣红冒小泡时下排骨翻炒上色',
                '加葱姜八角桂皮香叶炒香',
                '锅边淋料酒去腥,加生抽老抽调色',
                '加开水没过排骨,大火烧开转小火炖40分钟',
                '加盐调味,大火收汁至浓稠包裹排骨',
                '汤汁红亮、排骨软烂脱骨即可'
            ],
            'notes': '炒糖色小火,枣红就下排骨,别炒糊。'
        },
        # 清蒸鲈鱼
        {
            'id': 'lv_008',
            ...
            'difficulty': '简单',
            'servings': 2,
            'ingredients': ['鲈鱼 1条(约500g)', '葱 2根', '姜 1块', '红椒 半个', '蒸鱼豉油 3勺', '料酒 1勺', '食用油 2勺', '盐 少许'],
            'steps': [
                '鲈鱼处理干净,鱼身两面划几刀',
                '用盐和料酒里外抹匀腌制10分钟',
                '盘底铺葱段姜片,鱼放上,鱼腹塞葱姜',
        ...
        # 麻婆豆腐
        {
            ...
            'difficulty': '简单',
            'servings': 2,
            'ingredients': ['嫩豆腐 1块', '猪肉末 100g', '郫县豆瓣酱 1.5勺', '花椒粉 1勺', '蒜末 适量', '葱花 适量', '生抽 1勺', '料酒 1勺', '水淀粉 适量', '盐 少许'],
            'steps': [
                '嫩豆腐切2cm方块,加盐的开水中焯烫1分钟去豆腥',
                '锅中放油,下肉末煸至变色出油',
                '加郫县豆瓣酱小火炒出红油',
                '加蒜末炒香,锅边淋料酒',
                '加一碗开水,放入豆腐',
        ...
        # 蛋挞
        {
            ...
            'difficulty': '简单',
            'servings': 6,
            'ingredients': ['蛋挞皮 6个', '鸡蛋 2个', '纯牛奶 100ml', '淡奶油 50ml', '白糖 30g', '香草精 几滴(可选)'],
            'steps': [
                '蛋挞皮提前从冷冻取出回温',
                '牛奶加热至温热,加白糖搅拌融化',
                '牛奶晾凉后打入鸡蛋搅匀',
        ...
        # 吕小厨红烧肉
        {
            ...
            'difficulty': '中等',
            'servings': 4,
            'ingredients': ['五花肉 500g', '冰糖 30g', '生抽 3勺', '老抽 1勺', '料酒 2勺', '葱姜 适量', '八角 2个', '桂皮 1块', '香叶 2片', '盐 适量'],
            'steps': [
                '五花肉先燎一下猪皮去毛去腥',
                '冷水下锅焯水,加葱姜料酒,水开后煮5分钟',
                '捞出切两指宽的块',
                '锅中下少量油,放冰糖小火炒糖色',
                '糖色变枣红时下肉块翻炒上色',
                '加葱姜八角桂皮香叶炒香',
